...
const TOOLS = [
  ...
  { href: "/speed", label: "Page Speed", match: (path: string) => path.startsWith("/speed") },
  { href: "/search-console", label: "Search Data", match: (path: string) => path.startsWith("/search-console") },
